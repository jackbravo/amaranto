...
class BaseIssueForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'status_id'     => new sfWidgetFormDoctrineChoice(array('model' => 'Status', 'add_empty' => false)),
      'category_id'   => new sfWidgetFormDoctrineChoice(array('model' => 'Category', 'add_empty' => false)),
      'priority_id'   => new sfWidgetFormDoctrineChoice(array('model' => 'Priority', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'is_resolved'   => new sfValidatorBoolean(),
      ...
      'status_id'     => new sfValidatorDoctrineChoice(array('model' => 'Status')),
      'category_id'   => new sfValidatorDoctrineChoice(array('model' => 'Category')),
      'priority_id'   => new sfValidatorDoctrineChoice(array('model' => 'Priority')),
