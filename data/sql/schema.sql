CREATE TABLE entity (id INT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, code VARCHAR(50) UNIQUE, type SMALLINT, user_id INT, owner_id INT, parent_id INT, description TEXT, title VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX owner_id_idx (owner_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE entity (id INT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, code VARCHAR(50) UNIQUE, type SMALLINT, user_id INT, owner_id INT, parent_id INT, description TEXT, title VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX owner_id_idx (owner_id), INDEX user_id_idx (user_id), INDEX parent_id_idx (parent_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE entity ADD FOREIGN KEY (user_id) REFERENCES sf_guard_user(id) ON DELETE SET NULL;
