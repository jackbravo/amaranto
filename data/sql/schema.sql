...
CREATE TABLE status (id INT AUTO_INCREMENT, name VARCHAR(64), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE component (id INT AUTO_INCREMENT, name VARCHAR(64), project_id INT, owner_id INT, INDEX project_id_idx (project_id), INDEX owner_id_idx (owner_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE component ADD FOREIGN KEY (project_id) REFERENCES project(id);
ALTER TABLE component ADD FOREIGN KEY (owner_id) REFERENCES sf_guard_user(id);
